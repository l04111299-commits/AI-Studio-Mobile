...
# --- Groq Setup (Yahan apni NAYI API KEY dalain) ---
API_KEY = "YAHAN_APNI_NAYI_KEY_DALAIN" 
client = Groq(api_key=API_KEY)

st.set_page_config(page_title="AI Studio Fixed", page_icon="🎙️", layout="wide")
...
with tab5:
    ...
    prompt = st.text_input("Image Prompt (English):")
